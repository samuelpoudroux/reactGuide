...
Dans le contexte de notre IHM, l'application globale présentera un router qui redirigera vers chaque features. Ensuite chaque feature gére son propre router.
